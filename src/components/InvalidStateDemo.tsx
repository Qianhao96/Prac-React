...
const InvalidStateDemo = () => {
    ...
    const [value6, setValue6] = useState<Date | Date[] | string | null>(null);
                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-6">
                            ...
                            <div className="field">
                                ...
                                <InputNumber id="inputnumber" value={value3} onValueChange={(e) => setValue3(e.target.value ?? null)} className="p-invalid"></InputNumber>
                            </div>
                            <div className="field">
