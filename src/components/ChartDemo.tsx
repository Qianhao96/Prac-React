...
const getLineChartOptions = (): ChartOptions => {
...
const getBarChartOptions = (): ChartOptions => {
    const textColor = getComputedStyle(document.body).getPropertyValue('--text-color') || 'rgba(0, 0, 0, 0.87)';
    const gridLinesColor = getComputedStyle(document.body).getPropertyValue('--divider-color') || 'rgba(160, 167, 181, .3)';
    const fontFamily = getComputedStyle(document.body).getPropertyValue('--font-family');
...
const getPieChartOptions = (): ChartOptions => {
    const textColor = getComputedStyle(document.body).getPropertyValue('--text-color') || 'rgba(0, 0, 0, 0.87)';
    const fontFamily = getComputedStyle(document.body).getPropertyValue('--font-family');
    return {
        plugins: {
...
const getPolarChartOptions = (): ChartOptions => {
    const textColor = getComputedStyle(document.body).getPropertyValue('--text-color') || 'rgba(0, 0, 0, 0.87)';
    const fontFamily = getComputedStyle(document.body).getPropertyValue('--font-family');
    const gridLinesColor = getComputedStyle(document.body).getPropertyValue('--divider-color') || 'rgba(160, 167, 181, .3)';
...
const getRadarChartOptions = (): ChartOptions => {
    const textColor = getComputedStyle(document.body).getPropertyValue('--text-color') || 'rgba(0, 0, 0, 0.87)';
    const fontFamily = getComputedStyle(document.body).getPropertyValue('--font-family');
    const gridLinesColor = getComputedStyle(document.body).getPropertyValue('--divider-color') || 'rgba(160, 167, 181, .3)';
...
//Apply ChartOptions type
let lineChartOptions: ChartOptions = getLineChartOptions();
let pieChartOptions: ChartOptions = getPieChartOptions();
let polarChartOptions: ChartOptions = getPolarChartOptions();
let barChartOptions: ChartOptions = getBarChartOptions();
let radarChartOptions: ChartOptions = getRadarChartOptions();
